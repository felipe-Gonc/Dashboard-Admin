	...
	return (
		...
		>
			<div className='flex items-center mb-4'>
				...
				<h2 className='text-xl font-semibold text-gray-100'>EXCLUIR CONTA</h2>
			</div>
			<p className='text-gray-300 mb-4'>Excluir permanentemente sua conta e todo o seu conteúdo.</p>
			<button
